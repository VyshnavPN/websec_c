...
export default function Hero() {
  ...
  const handleContextLost = (e, gl) => {
    ...
    // bump the key to remount Canvas instead of full reload
    setCanvasKey((k) => k + 1);
  };
    ...
    <>
      ...
      <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
        ...
        <Canvas
          ...
          onCreated={({ gl }) => {
            gl.domElement.addEventListener('webglcontextlost', (e) => handleContextLost(e, gl));
            gl.domElement.addEventListener('webglcontextrestored', () => {
              console.log('WebGL context restored (hero)');
            });
          }}
        >
